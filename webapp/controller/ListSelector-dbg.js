/**
 * THIS FILE IS GENERATED FROM MASTER DETAIL TEMPLATE
 */
sap.ui.define([
    "sap/ui/base/Object",
    "sap/base/Log"
    ...
    return BaseObject.extend("com.wel.goodsreceipt.controller.ListSelector", {
        ...
        constructor: function () {
            ...
            this.oWhenListLoadingIsDone = new Promise(function (fnResolve, fnReject) {
                ...
                this._oWhenListHasBeenSet
                    .then(function (oList) {
                        //console.log("list selector", oList);
                        oList.getBinding("items").attachEventOnce("dataReceived",
                            function () {
                                if (this._oList.getItems().length) {
                                    //console.log(this._oList.getItems().length);
                                    fnResolve({
                                        list: oList
                                    });
                                } else {
